...
面向政府机关日常办公场景的 AI 助手产品原型，覆盖知识库问答、AI 工具、材料写作与公文校核、会议纪要及知识库管控。

> 当前仓库以可交互静态 Demo 和产品设计资料为主。页面数据及 AI 结果均为 Mock 示例，不代表生产系统或正式政务结论。
...
- **AI 助手**：公文起草、综合材料、讲话稿、政务宣传、公文校核和会议纪要。
