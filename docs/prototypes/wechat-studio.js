...
(() => {
  ...
  function setup(){
    ...
    const generate=h.querySelector('#wxGenerate');if(generate)generate.textContent=wxState.articleReady?'继续编辑当前方案':wxState.outputMode==='story'?'查看连续草图示例':'查看 10 套排版效果';
